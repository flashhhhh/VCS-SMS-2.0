...
type ServerAdministrationServiceClient interface {
	...
	UpdateStatus(ctx context.Context, in *ServerStatus, opts ...grpc.CallOption) (*EmptyResponse, error)
}
...
func (c *serverAdministrationServiceClient) UpdateStatus(ctx context.Context, in *ServerStatus, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ServerAdministrationServiceServer interface {
	...
	UpdateStatus(context.Context, *ServerStatus) (*EmptyResponse, error)
...
func (UnimplementedServerAdministrationServiceServer) UpdateStatus(context.Context, *ServerStatus) (*EmptyResponse, error) {
...
func _ServerAdministrationService_UpdateStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerAdministrationServiceServer).UpdateStatus(ctx, req.(*ServerStatus))
	}
	return interceptor(ctx, in, info, handler)
}
